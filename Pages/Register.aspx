...
<body>
    <form id="form1" runat="server">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
            <div class="container">
                <a class="navbar-brand fw-bold text-primary" href="Index.aspx">NepStudy</a>
        ...
        <div class="container-fluid pt-5">
            <div class="row">
                <div class="col-md-6 left-panel d-none d-md-flex">
                    <img src="https://52df751a.delivery.rocketcdn.me/wp-content/uploads/2022/12/Will-web-development-die-in-10-years-1.jpg" alt="Register Illustration" />
                </div>
