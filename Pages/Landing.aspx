...
<head runat="server">
    <meta charset="UTF-8">
    <title>NepStudy - Unlock Your Learning Potential</title>
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <a href="Login.aspx" class="btn btn-outline-secondary btn-lg">View Courses</a>
                </div>
                <div class="col-md-6 text-center">
                    <img src="https://blog.hyperiondev.com/wp-content/uploads/2019/02/Blog-Types-of-Web-Dev.jpg" alt="Hero Image" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row row-cols-1 row-cols-md-4 g-4">
                <div class="col">
                    <div class="card course-card h-100">
                        <img src="https://digital8.com.au/wp-content/uploads/2016/12/Blog-post-on-web-dev-.jpg" class="card-img-top" alt="Course">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card course-card h-100">
                        <img src="https://togglemax.com/wp-content/uploads/2023/01/slider-img.png" class="card-img-top" alt="Course">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card course-card h-100">
                        <img src="https://cdn.hackr.io/uploads/posts/large/1627884166eKgVi1YLix.png" class="card-img-top" alt="Course">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card course-card h-100">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm7AXcC9z3lPM4QXXfH6bsBN4_5mqytoeilw&s" class="card-img-top" alt="Course">
                        <div class="card-body">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p class="mb-4">Join thousands of students who are transforming their future with NepStudy.</p>
