...
<body>
    ...
    <section class="py-5 mt-5 text-center bg-light">
        <div class="container">
            ...
            <p class="lead">NepStudy brings accessible, affordable, and high-quality digital learning to every student, anywhere.</p>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="https://images.pexels.com/photos/20044370/pexels-photo-20044370.jpeg" class="img-fluid rounded" alt="Vision">
                </div>
                <div class="col-md-6">
    ...
    <section class="py-5 text-center">
        <div class="container">
            ...
            <p class="mb-5">Our diverse, talented, and passionate team drives NepStudy’s mission forward.</p>
            <div class="row g-4">
                <div class="col-md-3">
                    <img src="https://plus.unsplash.com/premium_photo-1689977968861-9c91dbb16049?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHByb2ZpbGUlMjBwaWN8ZW58MHx8MHx8fDA%3D" class="team-img mb-3" alt="Alex">
                    <h6>Alexandra Williams</h6>
                    <p class="text-muted">Co-Founder & CEO</p>
                </div>
                <div class="col-md-3">
                    <img src="https://plus.unsplash.com/premium_photo-1689977968861-9c91dbb16049?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHByb2ZpbGUlMjBwaWN8ZW58MHx8MHx8fDA%3D" class="team-img mb-3" alt="Michael">
                    <h6>Michael Chang</h6>
                    <p class="text-muted">Head of Product</p>
                </div>
                <div class="col-md-3">
                    <img src="https://plus.unsplash.com/premium_photo-1689977968861-9c91dbb16049?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHByb2ZpbGUlMjBwaWN8ZW58MHx8MHx8fDA%3D" class="team-img mb-3" alt="Sarah">
                    <h6>Sarah Johnson</h6>
                    <p class="text-muted">Marketing Director</p>
                </div>
                <div class="col-md-3">
                    <img src="https://plus.unsplash.com/premium_photo-1689977968861-9c91dbb16049?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHByb2ZpbGUlMjBwaWN8ZW58MHx8MHx8fDA%3D" class="team-img mb-3" alt="James">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p class="mb-4">Join thousands of students transforming their future through NepStudy.</p>
    ...
    <footer class="footer">
        <div class="container text-center text-md-start">
            ...
            <div class="text-center mt-3">
                <p class="mb-0">&copy; 2025 NepStudy. All rights reserved.</p>
            </div>
        </div>
    </footer>
